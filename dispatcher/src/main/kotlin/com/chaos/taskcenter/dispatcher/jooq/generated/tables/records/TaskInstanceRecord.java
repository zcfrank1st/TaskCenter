...
public class TaskInstanceRecord extends UpdatableRecordImpl<TaskInstanceRecord> implements Record13<String, UInteger, String, String, String, UByte, String, UInteger, UByte, UInteger, Timestamp, Timestamp, Timestamp> {

    private static final long serialVersionUID = -935378175;
    ...
    /**
     * Setter for <code>task_center.task_instance.refer_task_instance_id</code>.
     */
    public void setReferTaskInstanceId(String value) {
        set(6, value);
    }

    /**
     * Getter for <code>task_center.task_instance.refer_task_instance_id</code>.
     */
    public String getReferTaskInstanceId() {
        return (String) get(6);
    }
    ...
    /**
     * Setter for <code>task_center.task_instance.retry_times</code>.
     */
    public void setRetryTimes(UInteger value) {
        set(9, value);
    }

    /**
     * Getter for <code>task_center.task_instance.retry_times</code>.
     */
    public UInteger getRetryTimes() {
     ...
     */
    @Override
    public Row13<String, UInteger, String, String, String, UByte, String, UInteger, UByte, UInteger, Timestamp, Timestamp, Timestamp> fieldsRow() {
     ...
     */
    @Override
    public Row13<String, UInteger, String, String, String, UByte, String, UInteger, UByte, UInteger, Timestamp, Timestamp, Timestamp> valuesRow() {
    ...
    public Field<String> field7() {
        return TaskInstance.TASK_INSTANCE.REFER_TASK_INSTANCE_ID;
    }
    ...
    public Field<UInteger> field10() {
        return TaskInstance.TASK_INSTANCE.RETRY_TIMES;
    }
     ...
     */
    @Override
    public TaskInstanceRecord value8(UInteger value) {
     ...
     */
    @Override
    public TaskInstanceRecord value9(UByte value) {
        setStatus(value);
        return this;
    }
     ...
     */
    @Override
    public TaskInstanceRecord value10(UInteger value) {
        setRetryTimes(value);
        return this;
    }
     ...
     */
    @Override
    public TaskInstanceRecord value13(Timestamp value) {
        setUpdateTime(value);
        return this;
    }
     ...
     */
    @Override
    public TaskInstanceRecord values(String value1, UInteger value2, String value3, String value4, String value5, UByte value6, String value7, UInteger value8, UByte value9, UInteger value10, Timestamp value11, Timestamp value12, Timestamp value13) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public TaskInstanceRecord(String taskInstanceId, UInteger taskId, String taskName, String taskContent, String param, UByte taskType, String referTaskInstanceId, UInteger retryTimeThreshold, UByte status, UInteger retryTimes, Timestamp executeTime, Timestamp createTime, Timestamp updateTime) {
        super(TaskInstance.TASK_INSTANCE);
