...
import com.chaos.taskcenter.jooq.generated.tables.ScheduledTaskSkeleton;
...
public class ScheduledTaskSkeletonRecord extends UpdatableRecordImpl<ScheduledTaskSkeletonRecord> implements Record15<UInteger, String, String, String, String, UByte, UInteger, Timestamp, Timestamp, Timestamp, String, String, String, UByte, UByte> {

    private static final long serialVersionUID = 1527320521;
    ...
    /**
     * Setter for <code>task_center.scheduled_task_skeleton.task_name</code>.
     */
    ...
    /**
     * Getter for <code>task_center.scheduled_task_skeleton.task_name</code>.
     */
    ...
    /**
     * Setter for <code>task_center.scheduled_task_skeleton.refer_task_ids</code>.
     */
    public void setReferTaskIds(String value) {
        set(12, value);
    }

    /**
     * Getter for <code>task_center.scheduled_task_skeleton.refer_task_ids</code>.
     */
    public String getReferTaskIds() {
        return (String) get(12);
    }

    /**
     * Setter for <code>task_center.scheduled_task_skeleton.is_init</code>. 0: 无 1: 正在初始化
     */
    public void setIsInit(UByte value) {
        set(13, value);
    }

    /**
     * Getter for <code>task_center.scheduled_task_skeleton.is_init</code>. 0: 无 1: 正在初始化
     */
    public UByte getIsInit() {
        return (UByte) get(13);
    }

    /**
     * Setter for <code>task_center.scheduled_task_skeleton.is_valid</code>. 0:有效 1:无效
     */
    ...
    /**
     * Getter for <code>task_center.scheduled_task_skeleton.is_valid</code>. 0:有效 1:无效
     */
     ...
     */
    @Override
    public Row15<UInteger, String, String, String, String, UByte, UInteger, Timestamp, Timestamp, Timestamp, String, String, String, UByte, UByte> fieldsRow() {
     ...
     */
    @Override
    public Row15<UInteger, String, String, String, String, UByte, UInteger, Timestamp, Timestamp, Timestamp, String, String, String, UByte, UByte> valuesRow() {
    ...
    public Field<String> field2() {
        return ScheduledTaskSkeleton.SCHEDULED_TASK_SKELETON.TASK_NAME;
    }
    ...
    public Field<String> field13() {
        return ScheduledTaskSkeleton.SCHEDULED_TASK_SKELETON.REFER_TASK_IDS;
    }
    ...
    public Field<UByte> field14() {
        return ScheduledTaskSkeleton.SCHEDULED_TASK_SKELETON.IS_INIT;
    }
    ...
    public Field<UByte> field15() {
        return ScheduledTaskSkeleton.SCHEDULED_TASK_SKELETON.IS_VALID;
    }
     ...
     */
    @Override
    public ScheduledTaskSkeletonRecord value6(UByte value) {
        setTaskType(value);
        return this;
    }
     ...
     */
    @Override
    public ScheduledTaskSkeletonRecord value8(Timestamp value) {
     ...
     */
    @Override
    public ScheduledTaskSkeletonRecord value11(String value) {
        setCreateUser(value);
        return this;
    }
     ...
     */
    @Override
    public ScheduledTaskSkeletonRecord value14(UByte value) {
        setIsInit(value);
        return this;
    }
     ...
     */
    @Override
    public ScheduledTaskSkeletonRecord value15(UByte value) {
        setIsValid(value);
        return this;
    }
     ...
     */
    @Override
    public ScheduledTaskSkeletonRecord values(UInteger value1, String value2, String value3, String value4, String value5, UByte value6, UInteger value7, Timestamp value8, Timestamp value9, Timestamp value10, String value11, String value12, String value13, UByte value14, UByte value15) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ScheduledTaskSkeletonRecord(UInteger taskId, String taskName, String quartzExpression, String taskContent, String param, UByte taskType, UInteger retryTimeThreshold, Timestamp lastExecuteTime, Timestamp createTime, Timestamp updateTime, String createUser, String updateUser, String referTaskIds, UByte isInit, UByte isValid) {
        super(ScheduledTaskSkeleton.SCHEDULED_TASK_SKELETON);
